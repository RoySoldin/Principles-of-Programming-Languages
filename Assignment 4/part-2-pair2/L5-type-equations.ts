...
const splitEquation = (equation: Equation): Equation[] =>
    (T.isProcTExp(equation.left) && T.isProcTExp(equation.right)) ?
        R.zipWith(makeEquation, R.prepend(equation.left.returnTE, equation.left.paramTEs),
                  R.prepend(equation.right.returnTE, equation.right.paramTEs)) :
    (T.isPairTExp(equation.left) && T.isPairTExp(equation.right)) ?
        R.zipWith(makeEquation, equation.left.Pair, equation.right.Pair):
    [];
